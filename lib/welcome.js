...
async function generarImagenBienvenida({ username, guildName, memberCount, avatar, background, botName, etiqueta = '⛧ BIENVENIDO A ⛧' }) {
  const ancho = 1024
  const alto = 450
  ...
  ctx.fillStyle = '#e0b0b0'
  textoConSombra(ctx, etiqueta, ancho - 40, 95)

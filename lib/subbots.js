...
function establecerPrefijo(numeroSubbot, prefijo) {
  const actual = leerDatos(numeroSubbot) || {}
  guardarDatos(numeroSubbot, { ...actual, prefijo })
}

function obtenerPrefijo(numeroSubbot) {
  return leerDatos(numeroSubbot)?.prefijo || null
}
